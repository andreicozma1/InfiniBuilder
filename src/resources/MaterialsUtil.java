...
//        grass.setSpecularMap(new Image("https://texturehaven.com/files/textures/jpg/1k/grass_path_2/grass_path_2_spec_1k.jpg"));
        ...
        clouds.setDiffuseMap(new Image(getClass().getResourceAsStream("textures/clouds.png")));
//        clouds.setSelfIlluminationMap(new Image(getClass().getResourceAsStream("textures/clouds.png")));
