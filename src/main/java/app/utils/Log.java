...
public class Log {
    ...
    public static void e(String TAG, String message) { if (verbose) System.out.println("*E* -> "+ new Timestamp( GameBuilder.time_current ).getTime()+ " : "+ TAG + " : " + message); }
    ...
    public static void d(String TAG, String message) { if (verbose) System.out.println(new Timestamp( GameBuilder.time_current ) + " *D-> "+ TAG + ": " + message); }
